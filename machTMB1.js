...
fxd_seq = "[1, 1, 2, 1, 1, 1, 1, 3, 1, 1, " +
           "1, 1, 2, 1, 1, 3, 2, 1, 1, 3, " + 
           "1, 1, 2, 1, 1, 1, 3, 1, 1, 1, " + 
           "2, 1, 1, 3, 1, 1, 1, 1, 1, 1]";
var machines = [["1", "Looks at past moves v. 1", "WTL(__moRSP__, [0.8, 0.1, 0.1], [0.1, 0.45, 0.45], [0.1, 0.45, 0.45], false);"],
                ["2", "Looks at past moves v. 2", "WTL(__moRSP__, [0.1, 0.45, 0.45], [0.1, 0.45, 0.45], [0.1, 0.45, 0.45], false);"],
                ["3", "Looks at past moves v. 3", "WTL(__moRSP__, [0.1, 0.45, 0.45], [0.1, 0.45, 0.45], [0.7, 0.25, 0.05], false);"],
                //["4", "BiasRnd1", "BiasedRandom(__moRSP__, [0.75, 0.125, 0.125]);"],
		["4", "Ignores past moves, but biased v. 1", "FixedSequence(__moRSP__, " + fxd_seq + ");"],
		["5", "Mimics past moves v. 1", "Mimic(__moRSP__, 0, 0.2);"]];
