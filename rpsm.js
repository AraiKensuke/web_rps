...
function You_win_or_lose(win,lose){
	...
	if (practiceMode)
	    {
		var pgo = document.getElementById("practiceorgoon");

		pgo.innerHTML = '<img src="done_practicing.jpg" height=30/><BR><img src="more_practice.jpg" height=30/><BR>';
		pgo.style.backgroundColor="blue";
		pgo.style.height=100;
		pgo.style.width=500;
		alert("should i be here, yes???");
	    }
	else
	    {
