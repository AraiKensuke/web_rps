...
{   //   IF a participantID was passed to this page
    ...
    $chkret = check_partID("TMB2", $partID_passed);  // check if valid ID
    $last_visit = $chkret[1];
    $valid_id = $chkret[0];
}
if ($valid_id)
...
to_block = nmachines;
sessionStorage.setItem("exptname", "TMB2");
...
sessionStorage.setItem("url_after_blocks", "4ChoiceQuestionnaire2.php");
