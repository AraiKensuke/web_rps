...
function Mimic(move_order, mode, epsilon) {
    this.epsilon;
    ...
    // hnd = [1, 2, 3]
    this.downgrade = function(hnd) {return this.dngrded[hnd-1]}
    this.upgrade = function(hnd) {return this.upgrded[hnd-1]}

    // returns 1,2,3 for order RSP
    this.predict = function(player) {   //   predicts player hand
